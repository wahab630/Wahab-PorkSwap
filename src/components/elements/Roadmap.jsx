        ...
        <div className="container">
          <div className="row py-5">
            ...
            <div className="col-lg-12 text-center">
              <img
                className="img-fluid  roadmap-img"
            ...
            <div className="col-lg-8">
              <img
                className="roadmap-img-two"
                src="https://porkswap.finance/assets/images/gov.png"
                alt=""
              />
            </div>
            <div className="col-lg-4">
              
                <h2 className="fw-bold ps-4 ">Governance Platform 
                <button className="roadmap-btn btn ms-5 fw-bold">
